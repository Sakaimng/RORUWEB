...
const en: Dict = {
  ...
  footer: {
    ...
    hoursWeekday: "SUN - THURS: 12 PM - 10 PM",
    hoursWeekdayCall: "(Last Call 9:30pm)",
    hoursWeekend: "FRI - SAT: 12 PM - 12 AM",
    hoursWeekendCall: "(Last Call 10:30pm)",
  },
  events: {
    heading: "Events",
    upcoming: "Upcoming",
...
const jp: Dict = {
  ...
  footer: {
    ...
    hoursWeekday: "日〜木: 12:00 - 22:00",
    hoursWeekdayCall: "（ラストオーダー 21:30）",
    hoursWeekend: "金〜土: 12:00 - 24:00",
    hoursWeekendCall: "（ラストオーダー 22:30）",
  },
  events: {
    heading: "イベント",
    upcoming: "今後の予定",
...
const cn: Dict = {
  ...
  footer: {
    ...
    hoursWeekday: "週日至週四：12:00 - 22:00",
    hoursWeekdayCall: "（最後點餐 21:30）",
    hoursWeekend: "週五至週六：12:00 - 00:00",
    hoursWeekendCall: "（最後點餐 22:30）",
  },
  events: {
    heading: "活動",
    upcoming: "即將舉行",
